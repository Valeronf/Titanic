...
def model(X, Y, learning_rate = 0.01, num_iterations = 100000, print_cost = True, lambd = 0, keep_prob = 0.9):
    """
...
parameters = model(X, Y, keep_prob = 0.9, learning_rate = 0.01)
...
pred.to_csv('preddrop0140str.csv')
