...
def model(X, Y, learning_rate = 0.01, num_iterations = 100000, print_cost = True, lambd = 0, keep_prob = 1):
    """
...
parameters = model(X, Y, learning_rate = 0.01, num_iterations = 100000, print_cost = True, lambd = 0, keep_prob = 1)

pred = predict(T,parameters)
pred = pred.T

pred = pd.DataFrame(pred)
pred.to_csv('simple01100str.csv')
